...
namespace RGBtoGreyTests
{
	...
	public class BitmapImageFileExportingTests
	{
		...
		{
			_bitmapImageFileExporting.ExportImageAsFile(_testBitmapImage, ImageFileFormats.jpg, _outputFileWithoutExt + ".jpg");
		...
		{
			_bitmapImageFileExporting.ExportImageAsFile(_testBitmapImage, ImageFileFormats.jpeg, _outputFileWithoutExt + ".jpg");
		...
		{
			_bitmapImageFileExporting.ExportImageAsFile(_testBitmapImage, ImageFileFormats.bmp, _outputFileWithoutExt + ".bmp");
		...
		{
			_bitmapImageFileExporting.ExportImageAsFile(_testBitmapImage, ImageFileFormats.png, _outputFileWithoutExt + ".png");
